...
class WarehouseView(QWidget):
    ...
    def update_products_table(self, products):
        ...
        for row, product in enumerate(products):
            ...
            self.products_table.setItem(row, 4, QTableWidgetItem(product["updated_at"]))
    ...
    def filter_products(self):
        ...
        for row in range(self.products_table.rowCount()):
            ...
            product_category = self.products_table.item(row, 1).text()
    ...
    def setup_ui(self):
        ...
        add_type_btn = QPushButton("Добавить тип товара")
        ...
        add_movement_btn = QPushButton("Регистрировать движение")
        ...
        self.products_table.setHorizontalHeaderLabels([
            "Название", "Категория", "Количество", "Единица измерения", "Последнее обновление"
        ])
...
class AddProductTypeDialog(QDialog):
    ...
    def setup_ui(self):
        self.setWindowTitle("Добавить тип товара")
        layout = QVBoxLayout(self)

        self.name_input = QLineEdit()
        self.name_input.setPlaceholderText("Название типа товара")
        
        self.category_input = QLineEdit()
        self.category_input.setPlaceholderText("Категория")
        
        self.unit_input = QLineEdit()
        self.unit_input.setPlaceholderText("Единица измерения")
...
class AddProductDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.type_combo.setPlaceholderText("Выберите тип товара")
        ...
        layout.addWidget(QLabel("Тип товара:"))
    ...
    def load_product_types(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for t in types:
                    self.type_combo.addItem(f"{t['name']} ({t['category']}, {t['unit']})", t['id'])
            else:
...
class ProductMovementDialog(QDialog):
    ...
    def setup_ui(self):
        self.setWindowTitle("Регистрация движения товара")
        layout = QVBoxLayout(self)
            ...
            if response.status_code == 200:
                ...
                for p in products:
                    self.product_combo.addItem(
                        f"{p['name']} (В наличии: {p['quantity']} {p['unit']})",
                        p['id']
                    )
            else:
